<?php $__env->startSection('title','Integración de Archivos'); ?>
...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="row">
      ...
      <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-5 text-center">
          ...
          <?php else: ?>
            ...
            <?php elseif($proceso->obtencion == 1): ?>
              <ul class='timeline'>
                <li class=''>Carga de archivos</li>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <?php if($covestro->usar_credito == 1): ?>
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <hr class="underline">
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/js/Administrador/index.js')); ?>"></script>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        tabla += '<div id="t1"><table class="display table table-bordered table-hover table-striped" id="tabla1">'+
                ...
                '</thead>'+
                '<tbody>';
                  <?php $__currentLoopData = $archivosTeso; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teso): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  arrayTesoreria.push(<?php echo e($teso->id_et); ?>);
                  arrayTesoreriaNombres.push('<?php echo e($teso->nombre); ?>');
                  tabla += '<tr class="text-muted text-center" id="">'+
                    '<td id="archivos-recientes-tesoreria"><?php echo e($teso->nombre); ?></td>'+
                    '<td id="date"><?php echo e($teso->fecha); ?></td>'+
                    '<td><input type="checkbox" id="teso<?php echo e($teso->id_et); ?>" value="teso<?php echo e($teso->id_et); ?>" onchange="tablaConstruida(1, this.value)"><button type="button" class="button btn-delete" onclick="eliminarTeso(1, <?php echo e($teso->id_et); ?>)"><i class="far fa-trash-alt"></i></button></td>'+
                  '</tr>'+
        ...
        tabla += '<div id="t2"><table class="display table table-bordered table-hover table-striped" id="tabla2">'+
                ...
                '</thead>'+
                '<tbody>';
                  <?php $__currentLoopData = $historialTeso; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teso): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  arrayTesoreria.push(<?php echo e($teso->id_et); ?>);
                  arrayTesoreriaNombres.push('<?php echo e($teso->nombre); ?>');
                  tabla += '<tr class="text-muted text-center" id="">'+
                    '<td id="archivos-recientes-tesoreria"><?php echo e($teso->nombre); ?></td>'+
                    '<td id="date"><?php echo e($teso->fecha); ?></td>'+
                    '<td><input type="checkbox" id="teso<?php echo e($teso->id_et); ?>" value="teso<?php echo e($teso->id_et); ?>" onchange="tablaConstruida(1, this.value)"></td>'+
                  '</tr>'+
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                '</tbody>'+
              '</table>';
        ...
        tabla += '<div id="t3"><table class="display table table-bordered table-hover table-striped" id="tabla3">'+
                ...
                '</thead>'+
                '<tbody>';
                  <?php $__currentLoopData = $archivosSAP; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teso): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  arraySAP.push(<?php echo e($teso->id_es); ?>);
                  arraySAPNombres.push('<?php echo e($teso->nombre); ?>');
                  tabla += '<tr class="text-muted text-center" id="">'+
                    '<td id="archivos-recientes-tesoreria"><?php echo e($teso->nombre); ?></td>'+
                    '<td id="date"><?php echo e($teso->fecha); ?></td>'+
                    '<td><input type="checkbox" id="sap<?php echo e($teso->id_es); ?>" value="sap<?php echo e($teso->id_es); ?>" onchange="tablaConstruida(2, this.value)"><button type="button" class="button btn-delete" onclick="eliminarTeso(3, <?php echo e($teso->id_es); ?>)"><i class="far fa-trash-alt"></i></button></td>'+
                  '</tr>'+
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                '</tbody>'+
              '</table>';
        ...
        tabla += '<div id="t4"><table class="display table table-bordered table-hover table-striped" id="tabla4">'+
                ...
                '</thead>'+
                '<tbody>';
                  <?php $__currentLoopData = $historialSAP; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teso): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  arraySAP.push(<?php echo e($teso->id_es); ?>);
                  arraySAPNombres.push('<?php echo e($teso->nombre); ?>');
                  tabla += '<tr class="text-muted text-center" id="">'+
                    '<td id="archivos-recientes-tesoreria"><?php echo e($teso->nombre); ?></td>'+
                    '<td id="date"><?php echo e($teso->fecha); ?></td>'+
                    '<td><input type="checkbox" id="sap<?php echo e($teso->id_es); ?>" value="sap<?php echo e($teso->id_es); ?>" onchange="tablaConstruida(2, this.value)"></td>'+
                  '</tr>'+
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                '</tbody>'+
              '</table>';
        ...
        tabla += '<div id="t5"><table class="display table table-bordered table-hover table-striped" id="tabla5">'+
                ...
                '</thead>'+
                '<tbody>';
                  <?php $__currentLoopData = $archivosCred; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teso): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  arrayCredito.push(<?php echo e($teso->id_ec); ?>);
                  arrayCreditoNombres.push('<?php echo e($teso->nombre); ?>');
                  tabla += '<tr class="text-muted text-center" id="">'+
                    '<td id="archivos-recientes-tesoreria"><?php echo e($teso->nombre); ?></td>'+
                    '<td id="date"><?php echo e($teso->fecha); ?></td>'+
                    '<td><input type="checkbox" id="cred<?php echo e($teso->id_ec); ?>" value="cred<?php echo e($teso->id_ec); ?>" onchange="tablaConstruida(3, this.value)"><button type="button" class="button btn-delete" onclick="eliminarTeso(5, <?php echo e($teso->id_ec); ?>)"><i class="far fa-trash-alt"></i></button></td>'+
                  '</tr>'+
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                '</tbody>'+
              '</table>';
        ...
        tabla += '<div id="t6"><table class="display table table-bordered table-hover table-striped" id="tabla6">'+
                ...
                '</thead>'+
                '<tbody>'+
                  <?php $__currentLoopData = $historialCred; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teso): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  arrayCredito.push(<?php echo e($teso->id_ec); ?>);
                  arrayCreditoNombres.push('<?php echo e($teso->nombre); ?>');
                  tabla += '<tr class="text-muted text-center" id="">'+
                    '<td id="archivos-recientes-tesoreria"><?php echo e($teso->nombre); ?></td>'+
                    '<td id="date"><?php echo e($teso->fecha); ?></td>'+
                    '<td><input type="checkbox" id="cred<?php echo e($teso->id_ec); ?>" value="cred<?php echo e($teso->id_ec); ?>" onchange="tablaConstruida(3, this.value)"></td>'+
                  '</tr>'+
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                '</tbody>'+
              '</table>';
