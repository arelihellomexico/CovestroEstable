...
<?php $__env->startSection('title','Validacion archivos SAP'); ?>
<?php $__env->startSection('usuario','Usuario SAP'); ?>
<?php $__env->startSection('validacionMenu','no-mostrar'); ?>
<?php $__env->startSection('tesoreriaMenu','no-mostrar'); ?>
...
<?php endif; ?>
<?php $__env->startSection('sapMenu','sap-active'); ?>
...
<div class="row">
  ...
  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <p class="text-muted lead text-left">SAP<img href="" src="<?php echo e(asset('assets/img/bank.svg')); ?>" class="icon-header"></p>
  </div>
  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <hr class="underline">
  </div>
      ...
      <div class="form-group">
        ...
        <div class="col-6 col-xs-6 col-sm-6 col-md-2 col-lg-2">
          <select id="layout" name="layout" class="form-control layo">
            ...
            <option value="<?php echo e($l->id_ls); ?>"><?php echo e($l->nombre); ?></option>
...
<div class="row">
  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <p class="text-muted lead text-left">Resultados de validación<img href="" src="<?php echo e(asset('assets/img/bank.svg')); ?>" class="icon-header"></p>
  </div>
  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <hr class="underline">
  </div>
