...
<html lang="es" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Validación Archivos Tesoreria</title>
    <!--Añadimos Bootstrap -->
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-4 col-xs-4 col-sm-4 col-md-2 col-lg-2 sidemenu">
          ...
          <hr class="divider">
          <br>
          <a href="#" class="validacion-active"><small><i class="icon-cloud-upload"></i> Validación de <br>archivos</small></a>
          <!--div class="container-items-menu"-->
            ...
            <a href="{{url('/logout')}}" class="cerrar"><i class="icon-login"></i> <small>Cerrar sesión</small></a>
          <!--/div-->
        </div>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 container-header">
                <p class="text-muted lead text-left"><big>Tesorería</big> <img href="" src="{{asset('assets/img/currency.svg')}}" class="icon-header"></p>
              </div>
              <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <hr class="underline">
              </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-6 col-xs-6 col-sm-6 col-md-2 col-lg-2">
                      <select id="layout" name="layout" class="form-control layo">
                        @foreach($layout as $l)
                          <option value="{{$l->id_lt}}">{{$l->nombre}}</option>
                        @endforeach
                      </select>
                    </div>
           ...
           <!--form id="formulario" action="javascript:cargarTabla()" method="post"-->
            ...
            <div class="row">
              <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 container-header">
                <p class="text-muted lead text-left">Resultados de validación <img href="" src="{{asset('assets/img/currency.svg')}}" class="icon-header"></p>
              </div>
              <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <hr class="underline">
              </div>
            ...
            <div class="row" id="contenedor">
              <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 scrollbar" id="scroll">
                <table class="display AllDataTable table table-bordered table-hover space table-striped" id="tableTesoreria">
                  <thead>
                    <tr>
  ...
  <script type="text/javascript">
    ...
    function cargarTabla(){
      ...
      var contenido = '<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 scrollbar" id="scroll">'+
                '<table class="display AllDataTable table table-bordered table-hover space table-striped" id="tableTesoreria2">'+
                  '<thead>'+
                    '<tr>'+
                      '<th class="text-center text-muted txt-thead"><small>Fecha de pago</small></th>'+
                      '<th class="text-center text-muted txt-thead"><small>Forma de pago</small></th>'+
  ...
  <script type="text/javascript" src="{{asset('assets/js/busqueda.js')}}"></script>
  <script type="text/javascript">
      //Tesoreria
