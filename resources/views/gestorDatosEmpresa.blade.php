...
@section('title','Gestor de datos de la empresa')
@section('covestroMenu','covestro-active')
@section('usuario','Usuario Administrador')
@section('contenido')
<!-- Encabezado -->
<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <h2 class="text-left"><img href="" id="img-covestro" src="{{asset('assets/img/planning.svg')}}" class="header"> Gestor de datos Covestro</h2>
  </div>
  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <p class="text-muted lead text-left">Datos de la empresa <img href="" id="img-covestro" src="{{asset('assets/img/planning.svg')}}" class="icon-header"></p>
    <hr class="underline">
  </div>
</div>
<!-- Fin encabezado -->
...
<div class="row">
  <div class="col-12 col-xs-12 col-sm-12 col-md-5 col-lg-5 col-lg-offset-1">
    <form action="javascript:actualizarDatos()" id="form_datos">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="rfc_e" name="rfc_r" placeholder="RFC del contribuyente" required value="{{$datos->rfc_e}}" disabled>
        <p id="p_rfc_e" class="text-light text-center bg-danger"></p>
      </div>
      <div class="form-group">
        <label for="nombre_e">Nombre del emisor</label>
        <input type="text" class="form-control" id="nombre_e" name="nombre_e" placeholder="Nombre del emisor" required value="{{$datos->nombre_e}}" disabled>
        <p id="p_nombre_e" class="text-light text-center bg-danger"></p>
      </div>
      <div class="form-group">
        <label for="metpago">Método de pago</label>
        <input type="text" class="form-control" id="metpago" name="metpago" placeholder="Método de pago" required value="{{$datos->metpago}}" disabled>
        <p id="p_metpago" class="text-light text-center bg-danger"></p>
      </div>
      <div class="form-group">
        <label for="iddoc">Versión Fiscal</label>
        <input type="text" class="form-control" id="version_fiscal" name="version_fiscal" placeholder="Versión Fiscal" required value="{{$datos->version_fiscal}}" disabled>
        <p id="version_fiscal" class="text-light text-center bg-danger"></p>
      </div>
      <div class="form-group">
        <label for="iddoc">Versión Complemento</label>
        <input type="text" class="form-control" id="version_complemento" name="version_complemento" placeholder="Versión Fiscal" required value="{{$datos->version_complemento}}" disabled>
        <p id="version_complemento" class="text-light text-center bg-danger"></p>
      </div>
      <div class="form-group">
        <label for="folio">Regimen</label>
        <input type="text" class="form-control" id="regimen" name="regimen" placeholder="Regimen" required value="{{$datos->regimen}}" disabled>
        <p id="p_folio" class="text-light text-center bg-danger"></p>
      </div>
      <div class="form-group">
        <label for="lugar_expedicion">Número de pago</label>
        <input type="text" class="form-control" id="numpago" name="numpago" placeholder="Lugar de expedición" required disabled value="{{$datos->numpago}}">
  ...
  <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-5">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="calle_r" name="calle_r" placeholder="Calle" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"  value="{{$datos->calle_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="next_e" name ="next_e"  placeholder="Numero exterior" value="{{$datos->numext_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="nint_e" name="nint_e" placeholder="Número interior" value="{{$datos->numint_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="colonia_e" name="colonia_e" placeholder="Nombre de la colonia" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" value="{{$datos->colonia_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="local_e" name="localidad_r" placeholder="Nombre de la localidad/ciudad" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"  value="{{$datos->localidad_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="ref_e" name="ref_e" placeholder="Referencias" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" value="{{$datos->referencia_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="municip_e" name="municip_e" placeholder="Municipio" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"  value="{{$datos->municipio_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="estado_e" name="estado_e" placeholder="Estado" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" value="{{$datos->estado_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="pais_e" name="pais_e" placeholder="Pais" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" value="{{$datos->pais_e}}" disabled>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="cp_e" name="cp_e" placeholder="Código postal" value="{{$datos->cpostal_e}}" disabled>
...
<div class="row" id="seccion_banco">
  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <br><br>
    <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <p class="text-left lead text-dark"><img href="" id="img-covestro" src="{{asset('assets/img/planning.svg')}}" class="icon-header">Agregar banco</p>
      <hr class="underline">
    </div>
  </div>
...
<div class="row">
  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <!-- Encabezado -->
    <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <p class="text-left lead"><img href="" id="img-covestro" src="{{asset('assets/img/planning.svg')}}" class="icon-header">Tabla de bancos</p>
      <hr class="underline">
    </div>
    <!-- Fin encabezado -->
      ...
      <div id="contabla">
        <table class="display table table-bordered table-hover space table-striped" id="tableTesoreria">
          ...
          <tbody id="cuerpo">
            ...
            <tr>
              <td class="text-center" name="numcuenta"><small>{{$c->numcuenta}}</small></td>
              <td class="text-center" name="nombrebanco"><small>{{$c->nombrebanco}}</small></td>
              <td class="text-center" name="RFC_Banco"><small>{{$c->RFC_Banco}}</small></td>
              <td class="text-center" name="cuenta_clabe"><small>{{$c->cuenta_clabe}}</small></td>
              <td class="text-center" name="EDITAR"><button class="button btn-transparent" type="button" onclick="editarBanco('{{$c->numcuenta}}')"><i class="far fa-edit"></i></button></td>
              <td class="text-center" name="ELIMINAR"><button class="button btn-transparent" type="button" onclick="preliminar('{{$c->numcuenta}}')"><i class="far fa-trash-alt"></i></button></td>
            </tr>
            @endforeach
          </tbody>
        </table>
